...
module.exports = function(grunt) {    
    ...
    grunt.registerTask('writeIndex', function() {
        ...
        grunt.file.write("dist/index.html", "<!doctype html><html><head><meta http-equiv='refresh' content='0;url=demo/netCell/jquery.html'/></head></html>");
        // write an index file to the root of the docs dir (redirects to 'netCell')
        grunt.file.write("dist/doc/index.html", "<!doctype html><html><head><meta http-equiv='refresh' content='0;url=netCell'/></head></html>");
    });
    ...
    // reads the contents of netCell.html (the docs index), and writes it into all of the other files.
