...
var config = {
    project:{
        ...
        appid:'netCell',
        appname: '网优规划库', // App名字
        apptitle: '网优规划库', // 网页title
        appdescription: 'netCell', // App的描述
        copyright:'©中国移动贵州公司 版权所有',
        keywords: 'cmcc,netCell',
        version: '0.0.1',
    ...
    session:{
        ...
        // mysql_url :'mysql://localhost:3306/netCellData',
        // mongodb_url:'mongodb://mongoDB:27017/netCell',
        mongodb_url:'mongodb://127.0.0.1:27017/netCell'
    ...
    routes:{
        ...
        mappings: {
            ...
            '/project/netCell/routes/': project_url_prefix + '/api/netCell/'// 项目前台路由匹配路径

        },
        welcome_path:project_url_prefix + '/netCell',
    ...
    mongdb:{
        ...
        // url: 'mongodb://mongoDB:27017/netCell',
        url: 'mongodb://127.0.0.1:27017/netCell',
    ...
    memcached:{
        ...
        server_locations:['localhost:11211'],
        options:{debug: true}
    },
    mysql:{
        host: '127.0.0.1',
